...
parser.add_argument('-t','--target', help='emu|hw', required=True)
...
def cpuThread(ch, queue, emu_queue):
    ...
    while True:
        # print("%04X: %02X %02X %02X" % ( mpu.pc, getByte(mpu.pc), getByte(mpu.pc+1), getByte(mpu.pc+2) ) )
